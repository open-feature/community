# OpenFeature 2026 Governance Committee election

Please see **[the list of candidates running in the election here](https://github.com/open-feature/community/blob/main/Elections/2026/Candidates.md)**.
...
- Jan 6th - Jan 26th 2026 - period to submit nominations
- Jan 27th 2026 - official nominees list published
- Feb 2nd - Feb 16th 2026 - voting period
- Feb 18th 2026 - results announced
...
- If you've been nominated or are willing to nominate yourself: express your interest in [this issue](TBD - GitHub issue link will be added)
...
Anyone can track the 2026 election process via [this GitHub issue](TBD - GitHub issue link will be added).
We will ensure that all documents and assets related to the 2026 election process are public.

For the 2026 elections, [Helios Voting](https://vote.heliosvoting.org/) was chosen as it's a hosted solution with cryptographic guarantees that no GC members can meddle with the results.
...
Anybody is eligible to run for the Governance Committee. During the "call for nomination" period, people can be nominated or nominate themselves by expressing their interest in [this issue](TBD - GitHub issue link will be added) a Pull Request adding said candidate to the [candidates-2026.md](https://github.com/open-feature/community/blob/main/Elections/2026/Candidates.md) file in the OpenFeature community repository.
