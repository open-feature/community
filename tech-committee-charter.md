...
The TC is responsible for all technical development within the OpenFeature project, including:
...
* Deciding on and communicating about proposed donations to OpenFeature

The TC recognizes that maintainers of specific languages or sub-projects have significant autonomy over their SIG and implementations.  The TC’s focus is on cross-project or disputed concerns with a primary goal of seeking consensus to develop an appropriate technical solution. The TC will define OpenFeatures’s release vehicles and serve as the primary technical liaison body for the OpenFeature project with the CNCF's TOC, external open source projects, consortiums and groups.

## OpenFeature Project Operations

The TC will establish and maintain a development process for OpenFeature. The development process will establish guidelines for how the developers and community will operate.
...
* Alignment with OpenFeature’s goals and priorities
...
OpenFeature. The basic process for donating code is described [in
...
Leadership roles in OpenFeature project will be peer elected representatives of the community.
...
The OpenFeature project git repository is maintained by the TC and additional Maintainers who are added by the TC on an ongoing basis.

Individuals making significant and valuable contributions, can move through the project to leadership roles as outlined in the [Community Membership](./community-members.md) document. Modifications of the contents of the git repository are made on a collaborative basis as defined in the development process.

Project Members may opt to elevate significant or controversial modifications, or modifications that have not found consensus to the TC for discussion. The TC will serve as the final arbiter where required. The TC will additionally publish and maintain a development process guide for people looking to participate in the development effort.
